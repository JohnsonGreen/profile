...
<body>
	...
	<div id="examples">
		<ul>
			...
			<li><a href="example3.jsp" class="current" id="third">案例三</a></li>
		</ul>
	</div>
	<div class="cleaner"></div>
	<div id="example_menu">
		<ul>
			<li><a href="example3.jsp">总体</a></li>
			<li><a href="example3_spread.jsp">传播分析</a></li>
			<li><a href="example3_emotion.jsp" class="current">情感分析</a></li>
			<li><a href="example3_join.jsp">参与信息</a></li>
		</ul>
	</div>
	<!--<div class="cleaner"></div>-->
